...
type IntegrationForm struct {
	...
	TelegramBotPreviewLength string
...
func (i IntegrationForm) Merge(integration *model.Integration) {
	...
	integration.TelegramBotPreviewLength = i.TelegramBotPreviewLength
...
func NewIntegrationForm(r *http.Request) *IntegrationForm {
	return &IntegrationForm{
		...
		TelegramBotPreviewLength: r.FormValue("telegram_bot_preview_length"),
